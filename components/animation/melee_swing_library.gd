...
const DEFS := {
	&"SlashR": {
		...
		"wind": {
			"spine_upper": Vector3(-4, -16, 0), "hips": Vector3(0, -8, 0),
			"r_upper_arm": Vector3(110, 0, 56), "r_forearm": Vector3(34, 0, 0),
			"l_upper_arm": Vector3(10, 0, -16),
		},
		"strike": {
			"spine_upper": Vector3(2, 22, 0), "hips": Vector3(0, 12, 0),
		...
		"follow": {
			...
			"r_upper_arm": Vector3(58, 0, -40), "r_forearm": Vector3(26, 0, 0),
	...
	&"SlashL": {
		...
		"wind": {
			"spine_upper": Vector3(-4, 16, 0), "hips": Vector3(0, 8, 0),
			"r_upper_arm": Vector3(110, 0, -56), "r_forearm": Vector3(34, 0, 0),
			"l_upper_arm": Vector3(10, 0, -10),
		},
		"strike": {
			"spine_upper": Vector3(2, -22, 0), "hips": Vector3(0, -12, 0),
			"r_upper_arm": Vector3(56, 0, 34), "r_forearm": Vector3(10, 0, 0),
			"l_upper_arm": Vector3(2, 0, -10),
		},
		"follow": {
			"spine_upper": Vector3(6, -20, 0), "hips": Vector3(0, -10, 0),
			"r_upper_arm": Vector3(58, 0, 40), "r_forearm": Vector3(26, 0, 0),
			"l_upper_arm": Vector3(-4, 0, 10),
		},
	},
	&"Chop": {
		...
		"strike": {
			...
			"r_upper_arm": Vector3(62, 0, 2), "r_forearm": Vector3(6, 0, 0),
			"l_upper_arm": Vector3(34, 0, -6),
		},
		"follow": {
			"spine_upper": Vector3(22, 6, 0), "hips": Vector3(8, 2, 0),
			"r_upper_arm": Vector3(44, 0, -2), "r_forearm": Vector3(18, 0, 0),
	...
	&"DiagR": {
		...
		"strike": {
			"spine_upper": Vector3(6, 22, 0), "hips": Vector3(4, 12, 0),
			"r_upper_arm": Vector3(46, 0, -30), "r_forearm": Vector3(8, 0, 0),
			"l_upper_arm": Vector3(4, 0, 20),
		},
		"follow": {
			"spine_upper": Vector3(10, 20, 0), "hips": Vector3(6, 10, 0),
			"r_upper_arm": Vector3(52, 0, -34), "r_forearm": Vector3(20, 0, 0),
			"l_upper_arm": Vector3(-2, 0, 26),
		},
	},
	&"DiagL": {
	...
	&"Smash": {
		...
		"strike": {
			...
			"l_upper_arm": Vector3(46, 0, -4), "l_forearm": Vector3(4, 0, 0),
			"l_thigh": Vector3(20, 0, 0), "r_thigh": Vector3(20, 0, 0),
		},
		"follow": {
			"spine_upper": Vector3(30, 0, 0), "hips": Vector3(12, 0, 0),
			"r_upper_arm": Vector3(34, 0, 0), "r_forearm": Vector3(22, 0, 0),
			"l_upper_arm": Vector3(26, 0, 0), "l_forearm": Vector3(20, 0, 0),
