...
STATUS: ACTIVE
LAST_ITER: 47
UPDATED: 2026-08-27 (JST, cron run) — iter 47

## Current goal
Iter 47: Phase AG Prague doorway stone portal — framed historic entrance with jamb pair (PORTAL_JAMB_W 0.16 x PORTAL_JAMB_H 2.25 x PORTAL_JAMB_T 0.05) + header lintel (DOOR_W+2*JAMB_W+0.40 ~2.22 x PORTAL_LINTEL_H 0.18 x PORTAL_LINTEL_T 0.055) at DOOR_H+0.02+0.09, jambs at DOOR_H/2 (mid +/- DOOR_W/2+JAMB_W/2) centered on doorway length*0.5, pressed 0.045 outside historic entrance wall (>=5.0), deterministic per WorldSeed door_portal per building (PORTAL_PROB 0.65, 3-box triple: 2 jambs+1 lintel), visual-only, stone b9aa90 lerp 0.11, layer f0 tagged portal; BuildingBuilder._facade_door_portals via WorldSeed, visual-only, no collision; citytest + smoke green (1 new assertion).
