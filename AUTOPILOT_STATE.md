...
STATUS: ACTIVE
LAST_ITER: 40
UPDATED: 2026-08-27 (JST, cron run) — iter 40

## Current goal
Iter 40: Phase Z Prague window shutters — hinged wooden shutters (SHUTTER_T 0.025, SHUTTER_W 0.30 x SHUTTER_H 1.22, SHUTTER_GAP 0.04, SHUTTER_PROB 0.52) flanking historic windows, pressed as thin visual planes 0.045 outside historic long facades (>=5.0) at window sill-mid height, deterministic per WorldSeed shutter, gated historic, desaturated wood palette; BuildingBuilder._facade_shutters via WorldSeed, visual-only, no collision; citytest + smoke green (1 new assertion).
